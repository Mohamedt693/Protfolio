...
function Work({isDarkMode}) {
    ...
    const visibleData = showAll ? workData : workData.slice(0, 5);
    ...
    return (
        ...
        >
            ...
            className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
                Welcome to my web development protfolio!
                    ...
                    return (
                        ...
                        style={{backgroundImage: `url(${project.bgImage})`}}>
                            ...
                            >
                                ...
                                <div className='rounded-full border border-black w-9 aspect-square
